...
export default {
  ...
  files: [
    ...
    '!**/node_modules/**/*.map',
    '!**/node_modules/**/*.{d.ts,d.cts,d.mts}',
    '!**/node_modules/**/{vitest.config,vitest.config.*,jest.config,jest.config.*}',
    '!**/node_modules/**/*.{test,spec}.{js,cjs,mjs,ts,cts,mts,jsx,tsx}',
    '!**/node_modules/@proj-airi/stage-ui/src/**',
    '!**/node_modules/@proj-airi/font-cjkfonts-allseto/src/**',
